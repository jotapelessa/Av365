# Instruções do OpenSpec

Instruções para assistentes de codificação de IA usando OpenSpec para desenvolvimento orientado por especificações.
...
## Fluxo de Trabalho em Três Etapas

### Etapa 1: Criando Mudanças
...
### Etapa 2: Implementando Mudanças
